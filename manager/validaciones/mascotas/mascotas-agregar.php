...
if($foto==true){
	...
	if(isset($imgProducto) && !empty($imgProducto)){
		...
		$query=mysqli_query($mysqli,"INSERT INTO mascotas (id_usuario, nombre, fecha_nacimiento, edad, raza, especie, color, sexo, peso, tipo_peso, fecha_registro, estado) VALUES('$id_usuario','$nombre','$fecha_nacimiento','$edad','$raza','$especie','$color','$sexo','$peso','$tipo_peso','$fecha','0')");
