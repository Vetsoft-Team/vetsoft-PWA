...
$citas_editar = mysqli_query($mysqli, "UPDATE citas SET fecha_cita = '$fecha_cita', hora_cita = '$hora_cita', doctor = '$doctor_cita', motivo = '$motivo', descripcion = '$descripcion' where id_cita = '$id_cita' and id_mascota='$id_mascota'");
if ($citas_editar) {
