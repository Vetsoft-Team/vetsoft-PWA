...
require '../../manager/pdf/fpdf/fpdf.php';
require '../../conexion/conexion.php';

$id_mascota = $_GET['mascota'];
$id_usuario = $_SESSION['id_usuario'];

// Verificación de seguridad: la mascota debe pertenecer al usuario logueado
$check_pet = mysqli_query($mysqli, "SELECT * FROM mascotas WHERE id_mascota='$id_mascota' AND id_usuario='$id_usuario' AND estado='0'");
if (mysqli_num_rows($check_pet) == 0) {
    ob_end_clean();
    echo "<center><h3 style='margin-top: 50px; font-family: Arial; color: #cc0000;'>No tiene permisos para acceder a esta información.</h3></center>";
    exit;
}
