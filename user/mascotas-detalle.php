								...
								<div class="card">
									<div class="card-body">
										...
										<div class="row mb-3">
											...
											<div class="col-sm-9">
												<input type="number" name="" min=0 max=20 id="edad" class="form-control input-sm" readonly=""/>
											</div>
										</div>
										<div class="row mb-3">
											<div class="col-sm-3">
											...
											<div class="col-sm-4">
												<select type="text" class="form-control" id="Raza" required>
										...
										<div class="row mb-3">
											...
											<div class="col-sm-5">
												<select type="text" class="form-control" id="tipo_peso" required>
								...
								<div class="col-sm-12">
									<div class="card">
										<div class="card-body">
											...
											<div class="row">
												<div class="col-sm-12">
													<center><h5 class="mb-3">Internamientos<?php echo $nombre ?></h5></center>
												</div>
											</div>
